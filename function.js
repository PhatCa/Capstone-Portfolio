...
const textToType = "Hi, my name is Phat!";
...
function animateTypingEffect() {
  ...
  const nextCharacter = textToType[currentText.length];
  typingEffect.textContent = currentText + nextCharacter;
